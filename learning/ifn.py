...
class Network(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.fuzzy = FuzzyLayer.fromdimentions(3, 4, trainable=True)
...
def train(type, epochs, leaning_rate, features, output_features, data_file, mutation_file):
    ...
    model = Network(len(features),1).to(device)
...
def main(type, epochs, leaning_rate, features, output_features, data_file, mutation_file):
    if __name__ == '__main__':
        freeze_support()
        train(type, epochs, leaning_rate, features, output_features, data_file, mutation_file)

#triangle
#main("triangle", 20, 0.01, ['side_a','side_b','side_c'], ['triangle_type'], './dataset_generator/triangle_dataset/data/dataset.csv', '')

#triangle multioutput
main("triangle", 100, 0.01, ['side_a','side_b','side_c'], ['triangle_type1','triangle_type2','triangle_type3','triangle_type4'], './dataset_generator/triangle_dataset/data/dataset_multioutput.csv', '')

#bank_credit
#main("credit", 100, 0.001, ['age','yearly_salary','year_wanted','preffed_custommer'], ['cat'], './dataset_generator/credit_dataset/data/dataset.csv', './dataset_generator/credit_dataset/fault_injection/data/dataset.csv')